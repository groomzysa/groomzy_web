  ...
  return (
    <>
      <Grid container justifyContent="center">
        <Tooltip
          title={`Actions for ${params.row.fullname}`}
          placement="top-start"
        >
          <MoreVertOutlined
      ...
      <Menu className={classes.menuItem} {...bindMenu(popupState)}>
        <MenuItem onClick={popupState.close}>
          <Grid
            ...
            onClick={() => navigate(encodeURI(`view_staff/${params.row.id}`))}
          >
            <Grid item>View</Grid>
            <Grid item>
              <VisibilityOutlined />
        ...
        <MenuItem onClick={popupState.close}>
          <Grid
            ...
            container
            justifyContent="space-between"
            onClick={() => navigate(encodeURI(`edit_staff/${params.row.id}`))}
          >
            <Grid item>Edit</Grid>
            <Grid item>
              <EditOutlined />
        ...
        <MenuItem onClick={popupState.close}>
          <Grid
            ...
            container
            justifyContent="space-between"
            onClick={() => navigate(encodeURI(`delete_staff/${params.row.id}`))}
          >
