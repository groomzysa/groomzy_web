...
export const TermsAndConditions: FC = () => {
  ...
  const handlePrivacyPolicyClick = () => {
    navigate(encodeURI(`/${PRIVACY_POLICY.toLowerCase()}`));
  };
  return (
    <Grid container>
      <Grid item md={3}></Grid>
      <Grid item md={6}>
        <Grid container direction="column">
            ...
            <Grid container alignItems="flex-end" justifyContent="flex-end">
              <Grid item>
                <GButton
                  ...
                  children={
                    <span>
                      Click here for <strong>Privacy policy</strong>
                    </span>
                  }
                  variant="text"
                />
          ...
          <Grid className={classes.pageTitles} item>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Groomzy, Online.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Groomzy, accessible from{" "}
                  <a
                    href="https://www.groomzy.co.za"
                    target="_blank"
                    rel="noreferrer"
                  >
                    https://www.groomzy.co.za
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email: info@groomzy.co.za</p>
              </li>
              <li>
                <p>
